...
class DAO:
    ...
    def registrarTique(self, tique: Tique, cliente: Cliente):
        ...
        sql_insert_tique = "INSERT INTO tique (Detalle_servicio, Fecha_Creacion, Detalle_Problema, area_ID_Area1, tipo_ID_Tipo1, criticidad_ID_Criticidad, cliente_ID_cliente, estado_ID_Estado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
        values_insert_tique = (
